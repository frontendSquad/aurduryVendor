...
<section id="user-listing" class="user-listing-page">
    <div class="page-title mb-4">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-md-end text-start">
                <a href="blocked-user.php" class="btn btn-blue fs-18 lh-21 fw-bold">Blocked Users</a>
            </div>
        </div>
    </div>
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="view-user.php"><i class="fa fa-eye"></i>View</a>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".user-blocked"><i class="fas fa-ban"></i>Block</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
