...
$pg = "newsletter-listing";
include('../include/header.php');
?>

<!-- Basic form layout section start -->
<section id="newsletter-listing" class="newsletter-listing-page">
    <div class="page-title mb-4">
        <div class="row">
            <div class="col-md-6 col-sm-12 mb-md-0 mb-3">
                <h2>Newsletter Listing</h2>
            </div>
        </div>
    </div>
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".newsletter-unsubscribe"><i class="fa fa-eye"></i> Unsubscribe</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
