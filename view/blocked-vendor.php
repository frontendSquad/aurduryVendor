...
<section id="blocked-vendor" class="blocked-vendor-page">
    <div class="page-title mb-4">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <h2><a href="vendor-listing.php"><i class="fas fa-arrow-left"></i></a> Blocked Vendor</h2>
            </div>
        </div>
    </div>
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="view-block-vendor.php"><i class="fa fa-eye"></i>View</a>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".vendor-unblocked"><i class="fas fa-ban"></i>Unblock</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
