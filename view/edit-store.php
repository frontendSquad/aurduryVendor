    ...
    <div class="bg-white shadow-small rounded-10 p-md-5 p-3">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <input type="text" class="form-control d-inline-block mnw-100 fs-16 fw-normal text-gray rounded-10" value="Store A">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <button class="btn btn-blue fs-18 fw-bold mt-4" data-bs-toggle="modal" data-bs-target=".store-updated">Upload</button>
            </div>
        </div>
    </div>
</section>
