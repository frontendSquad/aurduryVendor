...
<section id="feedback-listing" class="feedback-listing-page">
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="view-feedback.php"><i class="fa fa-eye"></i> View</a>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".feedback-delete"><i class="fas fa-trash-alt"></i> Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
