...
<section id="view-vendor" class="view-vendor-page">
    <div class="page-title mb-4">
        <div class="row">
            <div class="col-6">
                <h2><a href="vendor-listing.php"><i class="fas fa-arrow-left"></i></a> Vendor Profile</h2>
            </div>
        </div>
    </div>
    <div class="bg-white rounded-10 shadow mb-5 p-md-5 p-3">
        <div class="row">
            ...
            <div class="col-sm-12 col-xl-12 col-xxl-10 mt-xl-0 mt-4">
                ...
                <a href="edit-vendor.php" class="btn btn-blue">Edit</a>
            </div>
        </div>
    </div>
