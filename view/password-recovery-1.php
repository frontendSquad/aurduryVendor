				...
				<div class="login-card bg-img p-0">
					<div class="row justify-content-end">
						<div class="col-12 col-lg-4">
							...
							<p class="fs-16 fw-regular text-gray mb-4">Enter Your Email Address to Proceed</p>
							<form action="password-recovery-2.php">
								...
								<div class="form-group text-center mt-2 mt-lg-3">
									<a href="password-recovery-2.php" type="sumit" class="btn btn-blue btn-login w-100 fs-20 fw-bold">Continue</a>
								</div>
