...
<section id="category-management" class="category-management-page">
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="add-category.php"><i class="fas fa-eye"></i>View</a>
                                        <a class="dropdown-item" href="edit-category.php"><i class="fas fa-edit"></i>Edit</a>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".category-blocked"><i class="fas fa-times"></i>Inactive</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="add-category.php"><i class="fas fa-eye"></i>View</a>
                                        <a class="dropdown-item" href="edit-category.php"><i class="fas fa-edit"></i>Edit</a>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".category-unblocked"><i class="fas fa-times"></i>Active</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
