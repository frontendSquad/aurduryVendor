<?php
$title = "Report Order Log";
$pg = "report-order-log";
include('../include/header.php');
?>

<!-- Basic form layout section start -->
<section id="report-order-log" class="report-order-log-page">
    <div class="page-title mb-4">
        <div class="row">
            <div class="col-md-6 col-sm-12 mb-md-0 mb-3">
                <h2>Report Order Logs</h2>
            </div>
        </div>
    </div>
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="view-report-log.php"><i class="fa fa-eye"></i> View</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
