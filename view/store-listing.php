...
<section id="store-listing" class="store-listing-page">
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="view-store-listing.php"><i class="fa fa-eye"></i>View Store</a>
                                        <a class="dropdown-item" href="edit-store-listing.php"><i class="fas fa-edit"></i>Edit Store</a>
                                        <a class="dropdown-item" href="view-store-listing.php"><i class="fa fa-eye"></i>View Inventory</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
